...
sysfs_extent_branch& sysfs_extent_tree::__root() { return __managed_vnode.parent_fs.get_extent_branch(__inode().extent_root.start); }
sysfs_extent_branch const& sysfs_extent_tree::__root() const { return __managed_vnode.parent_fs.get_extent_branch(__inode().extent_root.start); }
