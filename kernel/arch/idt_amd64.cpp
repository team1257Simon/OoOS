...
std::array<std::unordered_map<void*, ooos_kernel_module::isr_actor>, 16UZ> __managed_handlers{};
...
extern "C"
{
    ...
    void isr_dispatch(uint8_t idx)
    {
        ...
        { 
            ...
            kfx_save();
            for(std::pair<void* const, ooos_kernel_module::isr_actor>& p : __managed_handlers[irq]) p.second();
