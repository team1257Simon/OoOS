...
void rtc_driver::init_instance(uint8_t century_register) noexcept { __instance.__century_register = century_register; __instance.__is_12h = !(read_rtc_register<0x0Bui8>().b1); __instance.__is_bcd = !(read_rtc_register<0x0Bui8>().b2); interrupt_table::add_irq_handler(0ui8, LAMBDA_ISR() { __instance.rtc_time_update(); }); irq_clear_mask<0ui8>(); }
