...
elf64_object::elf64_object(file_inode *n) noexcept : __image_start{ std::aligned_allocator<char, elf64_ehdr>().allocate(n->size()) }, __image_size{ n->size() } { n->read(__image_start, __image_size); }
