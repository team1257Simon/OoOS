...
[[gnu::target("general-regs-only")]] kb_data keyboard_driver_amd64::__get_last(kb_state current_state) { return this->__get_next(current_state, false); }
[[gnu::target("general-regs-only")]] bool keyboard_driver_amd64::__skip_send() { if(__skip) { __skip = false; return true; } return false; }
