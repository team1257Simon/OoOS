...
unsigned int task_wait_queue::cumulative_remaining_ticks() const noexcept { unsigned int result = 0; for(const_iterator i = current(); i != end(); i++) result += (*i)->task_ctl.wait_ticks_delta; return result; }
