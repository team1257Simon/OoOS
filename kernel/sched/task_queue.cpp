...
task_pl_queue &prio_level_task_queues::operator[](priority_val pv) noexcept { return this->__base::operator[](__idx_by_prio(pv)); }
task_pl_queue const &prio_level_task_queues::operator[](priority_val pv) const noexcept { return this->__base::operator[](__idx_by_prio(pv)); }