...
class fifo_buffer : protected std::__impl::__dynamic_queue<CT, AT>, public virtual std::basic_streambuf<CT, TT>
{
...
public:
    ...
    fifo_buffer(const_pointer start, const_pointer end, off_type n = size_type(0), size_type e = size_type(0)) : __base{ size_type(end - start) } { this->__qcopy(this->__qbeg(), start, size_type(end - start)); if(n > off_type(0)) this->__qsetn(size_type(n)); if(e) this->__qsete(e); }
...
public:
    ...
    bool reserve_at_least(size_t n) { return this->__qcapacity() >= n || this->__q_grow_buffer(size_type(n - this->__qcapacity())); }
