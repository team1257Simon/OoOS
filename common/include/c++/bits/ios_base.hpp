...
namespace std
{
    ...
    struct __fmtflags
    {
        ...
        constexpr __fmtflags operator&(__fmtflags const& that) const noexcept { return __fmtflags{ uint16_t(uint16_t(*this) & uint16_t(that)) }; }
        constexpr __fmtflags& operator&=(__fmtflags const& that) noexcept { return *this = (*this & that); }
        constexpr __fmtflags basefield() const noexcept { return *this & __fmtflags{ uint16_t(0b00000111) }; }
        constexpr __fmtflags adjustfield() const noexcept { return *this & __fmtflags{ uint16_t(0b00111000) }; }
        constexpr __fmtflags floatfield() const noexcept { return *this & __fmtflags{ uint16_t(0b11000000) }; }
    } __pack;
