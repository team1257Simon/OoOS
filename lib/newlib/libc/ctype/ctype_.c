...
const char                                    _ctype_b[128 + 256] = {
                                       ...
                                       040,       040,       040 | 010, 040 | 010, 040 | 010, 040 | 010, 040 | 010, 040, 040, 040, 040,        040, 040, 040,       040,
                                       040,       040,       040,       040,       040,       040,       040,       040, 040, 040, 010 | 0200, 020, 020, 020,       020,
                                       020,       020,       020,       020,       020,       020,       020,       020, 020, 020, 020,        04,  04,  04,        04,
                                       04,        04,        04,        04,        04,        04,        020,       020, 020, 020, 020,        020, 020, 01 | 0100, 01 | 0100,
                                       01 | 0100, 01 | 0100, 01 | 0100, 01 | 0100, 01,        01,        01,        01,  01,  01,  01,         01,  01,  01,        01,
                                       01,        01,        01,        01,        01,        01,        01,        01,  01,  020, 020,        020, 020, 020,       020,
                                       02 | 0100, 02 | 0100, 02 | 0100, 02 | 0100, 02 | 0100, 02 | 0100, 02,        02,  02,  02,  02,         02,  02,  02,        02,
...
const char _ctype_[1 + 256] = {
    0,   040, 040, 040,        040, 040, 040,       040,       040,       040,       040 | 010, 040 | 010, 040 | 010, 040 | 010, 040 | 010,
    040, 040, 040, 040,        040, 040, 040,       040,       040,       040,       040,       040,       040,       040,       040,
    040, 040, 040, 010 | 0200, 020, 020, 020,       020,       020,       020,       020,       020,       020,       020,       020,
    020, 020, 020, 020,        04,  04,  04,        04,        04,        04,        04,        04,        04,        04,        020,
    020, 020, 020, 020,        020, 020, 01 | 0100, 01 | 0100, 01 | 0100, 01 | 0100, 01 | 0100, 01 | 0100, 01,        01,        01,
    01,  01,  01,  01,         01,  01,  01,        01,        01,        01,        01,        01,        01,        01,        01,
    01,  01,  020, 020,        020, 020, 020,       020,       02 | 0100, 02 | 0100, 02 | 0100, 02 | 0100, 02 | 0100, 02 | 0100, 02,
