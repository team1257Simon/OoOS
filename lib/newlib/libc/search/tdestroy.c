...
static void        trecurse(root, free_action) node_t* root;
void (*free_action)(void*);
{
    if(root->llink != ((void*)0)) trecurse(root->llink, free_action);
    if(root->rlink != ((void*)0)) trecurse(root->rlink, free_action);
...
void tdestroy(void* vrootp, void (*freefct)(void*))
{
    ...
    if(root != ((void*)0)) trecurse(root, freefct);
}
