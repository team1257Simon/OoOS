 ...
 __uint32_t obucket, nbucket;
{
 ...
 old_bufp = __get_buf(hashp, obucket, 
                                     ((void *)0)
                                         , 0);
 if (old_bufp == 
                ((void *)0)
  ...
  return (-1);
 new_bufp = __get_buf(hashp, nbucket, 
                                     ((void *)0)
                                         , 0);
 if (new_bufp == 
                ((void *)0)
 ...
 while (n < ino[0]) {
  ...
  for (n = 1; (n < ino[0]) && (ino[n + 1] >= 4); n += 2) {
   ...
   if (__call_hash(hashp, key.data, key.size) == obucket) {
    ...
    if ((((op)[2] >= 4) && ((2*sizeof(__uint16_t) + (((&key)))->size + (((&val)))->size) + (2*sizeof(__uint16_t))) <= (((op))[((op))[0]+1])))
    ...
    if ((((np)[2] >= 4) && ((2*sizeof(__uint16_t) + (((&key)))->size + (((&val)))->size) + (2*sizeof(__uint16_t))) <= (((np))[((np))[0]+1])))
 ...
 const DBT *key, *val;
{
 ...
 while (bp[0] && (bp[2] < 4 || bp[bp[0]] < 4))
  ...
  if (bp[2] == 3 && bp[0] == 2)
   ...
   if (((bp)[(bp)[0]+1]) > (2*sizeof(__uint16_t) + (key)->size + (val)->size)) {
 ...
 int is_bucket, is_disk, is_bitmap;
{
 ...
 if ((fd == -1) || !is_disk) {
  { ((__uint16_t *)(p))[0] = 0; ((__uint16_t *)(p))[1] = hashp->hdr.bsize - 3 * sizeof(__uint16_t); ((__uint16_t *)(p))[2] = hashp->hdr.bsize; };
  return (0);
 }
 if (is_bucket)
  page = (bucket) + hashp->hdr.hdrpages + ((bucket) ? hashp->hdr.spares[__log2((bucket)+1)-1] : 0);
 else
  page = ((1 << (((__uint32_t)((bucket))) >> 11)) -1) + hashp->hdr.hdrpages + (((1 << (((__uint32_t)((bucket))) >> 11)) -1) ? hashp->hdr.spares[__log2(((1 << (((__uint32_t)((bucket))) >> 11)) -1)+1)-1] : 0) + (((bucket)) & 0x7FF);;
 if ((lseek(fd, (off_t)page << hashp->hdr.bshift, 
                                             0
                                                     ) == -1) ||
 ...
 if (!is_bitmap && !bp[0]) {
  { ((__uint16_t *)(p))[0] = 0; ((__uint16_t *)(p))[1] = hashp->hdr.bsize - 3 * sizeof(__uint16_t); ((__uint16_t *)(p))[2] = hashp->hdr.bsize; };
   ...
   if (is_bitmap) {
    ...
    for (i = 0; i < max; i++)
     { __uint32_t _tmp = ((int *)p)[i]; ((char *)&((int *)p)[i])[0] = ((char *)&_tmp)[3]; ((char *)&((int *)p)[i])[1] = ((char *)&_tmp)[2]; ((char *)&((int *)p)[i])[2] = ((char *)&_tmp)[1]; ((char *)&((int *)p)[i])[3] = ((char *)&_tmp)[0]; };
   } else {
    { __uint16_t _tmp = bp[0]; ((char *)&bp[0])[0] = ((char *)&_tmp)[1]; ((char *)&bp[0])[1] = ((char *)&_tmp)[0]; };
    max = bp[0] + 2;
    for (i = 1; i <= max; i++)
     { __uint16_t _tmp = bp[i]; ((char *)&bp[i])[0] = ((char *)&_tmp)[1]; ((char *)&bp[i])[1] = ((char *)&_tmp)[0]; };
   }
  }
 return (0);
}
 ...
 int is_bucket, is_bitmap;
{
 ...
 fd = hashp->fp;
  ...
  if (is_bitmap) {
   ...
   for (i = 0; i <= max; i++)
    { __uint16_t _tmp = ((__uint16_t *)p)[i]; ((char *)&((__uint16_t *)p)[i])[0] = ((char *)&_tmp)[1]; ((char *)&((__uint16_t *)p)[i])[1] = ((char *)&_tmp)[0]; };
  }
 }
 if (is_bucket)
  page = (bucket) + hashp->hdr.hdrpages + ((bucket) ? hashp->hdr.spares[__log2((bucket)+1)-1] : 0);
 ...
 int pnum, nbits, ndx;
{
 ...
 if ((ip = (__uint32_t *)malloc(hashp->hdr.bsize)) == 
                                                 ((void *)0)
                                                     )
  return (1);
 hashp->nmaps++;
 ...
 HTAB *hashp;
{
 ...
 for ( i = first_page; i <= free_page; i++ ) {
  ...
  for (; bit <= in_use_bits; j++, bit += 32)
   if (freep[j] != ((__uint32_t)0xFFFFFFFF))
    goto found;
 }
 ...
 if (free_bit == (hashp->hdr.bsize << 3) - 1) {
  ...
  if (__ibitmap(hashp,
      (int)((__uint32_t)((__uint32_t)(splitnum) << 11) + (offset)), 1, free_page))
   return (0);
  hashp->hdr.spares[splitnum]++;
 ...
 BUFHEAD *obufp;
{
 ...
 bit_address =
     (ndx ? hashp->hdr.spares[ndx - 1] : 0) + (addr & 0x7FF) - 1;
 ...
 int ndx;
{
 ...
 if ((hashp->mapp[ndx] = (__uint32_t *)malloc(hashp->hdr.bsize)) == 
                                                               ((void *)0)
                                                                   )
  return (
         ((void *)0)
