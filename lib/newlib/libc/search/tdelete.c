...
void*              tdelete(const void* restrict vkey, void** restrict vrootp, int (*compar)(const void*, const void*))
{
    node_t** rootp = (node_t**)vrootp;
    node_t * p, *q, *r;
    int      cmp;
    if(rootp == ((void*)0) || (p = *rootp) == ((void*)0)) return ((void*)0);
    while((cmp = (*compar)(vkey, (*rootp)->key)) != 0)
    {
        p     = *rootp;
        rootp = (cmp < 0) ? &(*rootp)->llink : &(*rootp)->rlink;
        if(*rootp == ((void*)0)) return ((void*)0);
    }
    r = (*rootp)->rlink;
    ...
    else if(r != ((void*)0))
    {
        ...
        {
            for(q = r->llink; q->llink != ((void*)0); q = r->llink) r = q;
            r->llink = q->rlink;
            q->llink = (*rootp)->llink;
            q->rlink = (*rootp)->rlink;
        }
