...
void* dlvsym(void* handle, const char* name, const char* version) __attribute__((weak, alias("__dlvsym")));
int dladdr(const void* addr, void* dli) __attribute__((weak, alias("__dladdr")));
int dlinfo(void* handle, int req, void* v) __attribute__((weak, alias("__dlinfo")));
...
void* __dlvsym(void* handle, const char* name, const char* version) { return NULL; }
