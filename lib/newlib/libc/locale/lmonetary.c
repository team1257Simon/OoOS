...
static char                                   empty[]            = "";
static char                                   numempty[]         = {0x7f, '\0'};
const struct lc_monetary_T                    _C_monetary_locale = {empty,    empty,    empty,    empty,    numempty, empty,    empty,   numempty,
                                                                    numempty, numempty, numempty, numempty, numempty, numempty, numempty};
...
int __monetary_load_locale(struct __locale_t* locale, const char* name, void* f_wctomb, const char* charset)
{
    int                  ret;
