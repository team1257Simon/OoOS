...
const char*                                   __locale_charset(struct __locale_t* locale) { return locale->ctype_codeset; }
const char*                                   __current_locale_charset(void) { return __get_current_locale()->ctype_codeset; }
...
const struct lc_ctype_T                       _C_ctype_locale = {"ASCII", numone};
int __ctype_load_locale(struct __locale_t* locale, const char* name, void* f_wctomb, const char* charset, int mb_cur_max)
{
    int               ret;
