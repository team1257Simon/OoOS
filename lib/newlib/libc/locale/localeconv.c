...
struct lconv* _localeconv_r(struct _reent* data) { return __localeconv_l(__get_current_locale()); }
struct lconv* localeconv(void) { return __localeconv_l(__get_current_locale()); }
