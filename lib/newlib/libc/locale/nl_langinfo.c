                      ...
                      : case 
                             DAY_6
                                  : case 
                                         DAY_7
                                              :
  ret = (char*) __get_time_locale (locale)->weekday[((int)item-
                                                   DAY_1
                                                   )];
  break;
 case 
                          ...
                          : case 
                                 ABDAY_6
                                        : case 
                                               ABDAY_7
                                                      :
  ret = (char*) __get_time_locale (locale)->wday[((int)item-
                                                ABDAY_1
                                                )];
  break;
 case 
                       ...
                       : case 
                              MON_11
                                    : case 
                                           MON_12
                                                 :
  ret = (char*) __get_time_locale (locale)->month[((int)item-
                                                 MON_1
                                                 )];
  break;
 case 
                           ...
                           : case 
                                  ABMON_11
                                          : case 
                                                 ABMON_12
                                                         :
  ret = (char*) __get_time_locale (locale)->mon[((int)item-
                                               ABMON_1
                                               )];
  break;
 case 
