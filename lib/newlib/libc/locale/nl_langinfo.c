...
char*                                         nl_langinfo_l(nl_item item, struct __locale_t* locale)
{
    ...
    case DAY_5:
    case DAY_6:
    case DAY_7: ret = (char*)__get_time_locale(locale)->weekday[((int)item - DAY_1)]; break;
    case ABDAY_1:
    case ABDAY_2:
    case ABDAY_3:
    case ABDAY_4:
    case ABDAY_5:
    case ABDAY_6:
    case ABDAY_7: ret = (char*)__get_time_locale(locale)->wday[((int)item - ABDAY_1)]; break;
    case MON_1:
    case MON_2:
    case MON_3:
    case MON_4:
    ...
    case MON_10:
    case MON_11:
    case MON_12: ret = (char*)__get_time_locale(locale)->month[((int)item - MON_1)]; break;
    case ABMON_1:
    case ABMON_2:
    case ABMON_3:
    case ABMON_4:
    ...
    case ABMON_10:
    case ABMON_11:
    case ABMON_12: ret = (char*)__get_time_locale(locale)->mon[((int)item - ABMON_1)]; break;
    ...
    case _NL_TIME_DATE_FMT: ret = (char*)__get_time_locale(locale)->date_fmt; break;
    ...
    case YESSTR: ret = (char*)__get_messages_locale(locale)->yesstr; break;
    case NOSTR: ret = (char*)__get_messages_locale(locale)->nostr; break;
    case CRNCYSTR:
        ret = "";
        ...
        if(*cs != '\0')
        {
            ...
            if(pos == __localeconv_l(locale)->n_cs_precedes)
            {
                ...
                if(pos == 0x7f)
                {
                    if(strcmp(cs, __get_monetary_locale(locale)->mon_decimal_point) == 0) psn = '.';
                }
                else
                    psn = pos ? '-' : '+';
                if(psn != '\0')
        ...
        break;
    case D_MD_ORDER: ret = (char*)__get_time_locale(locale)->md_order; break;
    default:
        if(item > (100000 + (0)) && item < (100000 + (7))) { return locale->categories[item - (100000 + (0))]; }
        ret = "";
    }
    return (ret);
}
char* nl_langinfo(nl_item item) { return nl_langinfo_l(item, __get_current_locale()); }
