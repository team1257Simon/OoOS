...
const struct lc_numeric_T                     _C_numeric_locale = {".", "", numempty};
int                                           __numeric_load_locale(struct __locale_t* locale, const char* name, void* f_wctomb, const char* charset)
{
    int                 ret;
