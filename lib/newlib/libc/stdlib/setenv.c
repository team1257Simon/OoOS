...
int                        setenv(const char* name, const char* value, int rewrite) { return _setenv_r(_impure_ptr, name, value, rewrite); }
int                        unsetenv(const char* name) { return _unsetenv_r(_impure_ptr, name); }
