...
void* _memalign_r(struct _reent *reent_ptr, size_t alignment, size_t bytes)
...

{
  ...
  if (alignment <= ((sizeof(size_t)) < 4 ? 8 : ((sizeof(size_t)) + (sizeof(size_t))))) return _malloc_r(reent_ptr, bytes);
  ...
  nb = (((unsigned long)((bytes) + ((sizeof(size_t)) + (((sizeof(size_t)) < 4 ? 8 : ((sizeof(size_t)) + (sizeof(size_t)))) - 1))) < (unsigned long)((sizeof(struct malloc_chunk)) + (((sizeof(size_t)) < 4 ? 8 : ((sizeof(size_t)) + (sizeof(size_t)))) - 1))) ? (((sizeof(struct malloc_chunk)) + (((sizeof(size_t)) < 4 ? 8 : ((sizeof(size_t)) + (sizeof(size_t)))) - 1)) & ~((((sizeof(size_t)) < 4 ? 8 : ((sizeof(size_t)) + (sizeof(size_t)))) - 1))) : (((bytes) + ((sizeof(size_t)) + (((sizeof(size_t)) < 4 ? 8 : ((sizeof(size_t)) + (sizeof(size_t)))) - 1))) & ~((((sizeof(size_t)) < 4 ? 8 : ((sizeof(size_t)) + (sizeof(size_t)))) - 1))));
  ...
  m = (char*)(_malloc_r(reent_ptr, nb + alignment + (sizeof(struct malloc_chunk))));
  ...
  {
    brk = (char*)((mchunkptr)((char*)(((unsigned long)(m + alignment - 1)) & -alignment) - 2*(sizeof(size_t))));
    if ((long)(brk - (char*)(p)) < (long)(sizeof(struct malloc_chunk))) brk = brk + alignment;
    ...
    _free_r(reent_ptr, ((void*)((char*)(p) + 2*(sizeof(size_t)))));
    p = newp;
  ...
  remainder_size = (sizeof (long) > sizeof (size_t) && ((p)->size & ~((0x1|0x2))) < nb ? -(long) (nb - ((p)->size & ~((0x1|0x2)))) : (long) (((p)->size & ~((0x1|0x2))) - nb));
