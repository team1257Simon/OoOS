 ...
 void __malloc_update_mallinfo()
{
  ...
  size_t avail = (((((mbinptr)((char*)&(__malloc_av_[2*(0) + 2]) - 2*(sizeof(size_t))))->fd))->size & ~((0x1|0x2)));
  int navail = ((long)(avail) >= (long)(sizeof(struct malloc_chunk)))? 1 : 0;

  for (i = 1; i < 128; ++i)
  {
    b = ((mbinptr)((char*)&(__malloc_av_[2*(i) + 2]) - 2*(sizeof(size_t))));
  ...
  __malloc_current_mallinfo.ordblks = navail;
  __malloc_current_mallinfo.uordblks = (__malloc_current_mallinfo.arena) - avail;
  __malloc_current_mallinfo.fordblks = avail;




  __malloc_current_mallinfo.keepcost = (((((mbinptr)((char*)&(__malloc_av_[2*(0) + 2]) - 2*(sizeof(size_t))))->fd))->size & ~((0x1|0x2)));
