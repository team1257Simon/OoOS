...
char* fcvt(double d, int ndigit, int* decpt, int* sign) { return fcvtbuf(d, ndigit, decpt, sign, ((void*)0)); }
char* fcvtf(float d, int ndigit, int* decpt, int* sign) { return fcvt((float)d, ndigit, decpt, sign); }
char* gcvtf(float d, int ndigit, char* buf)
{
    double asd = d;
    return gcvt(asd, ndigit, buf);
}
char* ecvt(double d, int ndigit, int* decpt, int* sign) { return ecvtbuf(d, ndigit, decpt, sign, ((void*)0)); }
char* ecvtf(float d, int ndigit, int* decpt, int* sign) { return ecvt((double)d, ndigit, decpt, sign); }
