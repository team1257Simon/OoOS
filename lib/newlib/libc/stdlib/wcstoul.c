...
unsigned long                                 _wcstoul_l(struct _reent* rptr, const wchar_t* nptr, wchar_t** endptr, int base, locale_t loc)
{
...
unsigned long wcstoul_l(const wchar_t* restrict s, wchar_t** restrict ptr, int base, locale_t loc)
{
    return _wcstoul_l(_impure_ptr, s, ptr, base, loc);
}
unsigned long wcstoul(const wchar_t* restrict s, wchar_t** restrict ptr, int base)
{
    return _wcstoul_l(_impure_ptr, s, ptr, base, __get_current_locale());
}
