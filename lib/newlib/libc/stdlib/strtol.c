...
static long _strtol_l(struct _reent* rptr, const char* restrict nptr, char** restrict endptr, int base, locale_t loc)
{
    ...
    cutoff = neg ? -(unsigned long)(-0x7fffffffffffffffL - 1L) : 0x7fffffffffffffffL;
    ...
    if(any < 0)
    {
        acc          = neg ? (-0x7fffffffffffffffL - 1L) : 0x7fffffffffffffffL;
        rptr->_errno = 34;
    }
    else if(neg)
        acc = -acc;
...
long _strtol_r(struct _reent* rptr, const char* restrict nptr, char** restrict endptr, int base)
{
    return _strtol_l(rptr, nptr, endptr, base, __get_current_locale());
}
long strtol_l(const char* restrict s, char** restrict ptr, int base, locale_t loc) { return _strtol_l(_impure_ptr, s, ptr, base, loc); }
long strtol(const char* restrict s, char** restrict ptr, int base) { return _strtol_l(_impure_ptr, s, ptr, base, __get_current_locale()); }
