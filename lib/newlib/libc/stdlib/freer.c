...
void                         _free_r(struct _reent* reent_ptr, void* mem)
{
    ...
    if(next == (((mbinptr)((char*)&(__malloc_av_[2 * (0) + 2]) - 2 * (sizeof(size_t))))->fd))
    {
        ...
        if((unsigned long)(sz) >= (unsigned long)__malloc_trim_threshold) _malloc_trim_r(reent_ptr, __malloc_top_pad);
        ...
        if(!islr && next->fd == (((mbinptr)((char*)&(__malloc_av_[2 * (1) + 2]) - 2 * (sizeof(size_t))))))
        {
            islr = 1;
            {
                (((mbinptr)((char*)&(__malloc_av_[2 * (1) + 2]) - 2 * (sizeof(size_t)))))->fd =
                    (((mbinptr)((char*)&(__malloc_av_[2 * (1) + 2]) - 2 * (sizeof(size_t)))))->bk = p;
                p->fd = p->bk = (((mbinptr)((char*)&(__malloc_av_[2 * (1) + 2]) - 2 * (sizeof(size_t)))));
            };
        }
        else
        {
    ...
    if(!islr)
    {
        if(sz < 512)
        {
            idx = (((unsigned long)(sz)) >> 3);
            ((((mbinptr)((char*)&(__malloc_av_[2 * (0) + 2]) - 2 * (sizeof(size_t))))->size) |= ((unsigned long)1 << (idx / 4)));
            bck     = ((mbinptr)((char*)&(__malloc_av_[2 * (idx) + 2]) - 2 * (sizeof(size_t))));
            fwd     = bck->fd;
            p->bk   = bck;
            p->fd   = fwd;
            fwd->bk = bck->fd = p;
        ...
        {
            idx = (((((unsigned long)(sz)) >> 9) == 0)    ? (((unsigned long)(sz)) >> 3) :
            ...
            {
                while(fwd != bck && sz < ((fwd)->size & ~((0x1 | 0x2)))) fwd = fwd->fd;
                bck = fwd->bk;
            }
            p->bk   = bck;
            p->fd   = fwd;
