...
size_t                                        _mbrtowc_r(struct _reent* ptr, wchar_t* pwc, const char* s, size_t n, mbstate_t* ps)
{
    int retval = 0;
    if(s == ((void*)0))
        retval = (__get_current_locale()->mbtowc)(ptr, ((void*)0), "", 1, ps);
    else
        retval = (__get_current_locale()->mbtowc)(ptr, pwc, s, n, ps);
    if(retval == -1)
    {
        ps->__count = 0;
        ptr->_errno = 138;
...
size_t mbrtowc(wchar_t* restrict pwc, const char* restrict s, size_t n, mbstate_t* restrict ps)
{
    ...
    if(s == ((void*)0))
        retval = (__get_current_locale()->mbtowc)(reent, ((void*)0), "", 1, ps);
    else
        retval = (__get_current_locale()->mbtowc)(reent, pwc, s, n, ps);
    if(retval == -1)
    {
        ps->__count   = 0;
        reent->_errno = 138;
