...
int                                           _mbtowc_r(struct _reent* r, wchar_t* restrict pwc, const char* restrict s, size_t n, mbstate_t* state)
{
    return (__get_current_locale()->mbtowc)(r, pwc, s, n, state);
}
int __ascii_mbtowc(struct _reent* r, wchar_t* pwc, const char* s, size_t n, mbstate_t* state)
{
    wchar_t        dummy;
    unsigned char* t = (unsigned char*)s;
    if(pwc == ((void*)0)) pwc = &dummy;
