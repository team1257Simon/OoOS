...
struct mallinfo mallinfo(void) { return _mallinfo_r(_impure_ptr); }
void            malloc_stats(void) { _malloc_stats_r(_impure_ptr); }
int             mallopt(int p, int v) { return _mallopt_r(_impure_ptr, p, v); }
...
void mstats(char* s) { _mstats_r(_impure_ptr, s); }
