...
unsigned long long                            _wcstoull_l(struct _reent* rptr, const wchar_t* nptr, wchar_t** endptr, int base, locale_t loc)
{
...
unsigned long long wcstoull_l(const wchar_t* restrict s, wchar_t** restrict ptr, int base, locale_t loc)
{
    return _wcstoull_l(_impure_ptr, s, ptr, base, loc);
}
unsigned long long wcstoull(const wchar_t* restrict s, wchar_t** restrict ptr, int base)
{
    return _wcstoull_l(_impure_ptr, s, ptr, base, __get_current_locale());
}
