...
static long long _strtoll_l(struct _reent* rptr, const char* restrict nptr, char** restrict endptr, int base, locale_t loc)
{
    ...
    cutoff = neg ? -(unsigned long long)(-0x7fffffffffffffffLL - 1LL) : 0x7fffffffffffffffLL;
    ...
    if(any < 0)
    {
        acc          = neg ? (-0x7fffffffffffffffLL - 1LL) : 0x7fffffffffffffffLL;
        rptr->_errno = 34;
    }
    else if(neg)
        acc = -acc;
...
long long _strtoll_r(struct _reent* rptr, const char* restrict nptr, char** restrict endptr, int base)
{
    return _strtoll_l(rptr, nptr, endptr, base, __get_current_locale());
}
long long strtoll_l(const char* restrict s, char** restrict ptr, int base, locale_t loc) { return _strtoll_l(_impure_ptr, s, ptr, base, loc); }
long long strtoll(const char* restrict s, char** restrict ptr, int base) { return _strtoll_l(_impure_ptr, s, ptr, base, __get_current_locale()); }
