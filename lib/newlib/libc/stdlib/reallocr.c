...

{
  ...
  if ((long)(oldsize) < (long)(nb))
  {
    ...
    if (next == (((mbinptr)((char*)&(__malloc_av_[2*(0) + 2]) - 2*(sizeof(size_t))))->fd) || !((((mchunkptr)(((char*)(next))+((next)->size & ~0x1)))->size) & 0x1))
    {
