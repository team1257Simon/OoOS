...
long long          atoll(const char* str) { return strtoll(str, (char**)((void*)0), 10); }
long long          _atoll_r(struct _reent* ptr, const char* str) { return _strtoll_r(ptr, str, (char**)((void*)0), 10); }
