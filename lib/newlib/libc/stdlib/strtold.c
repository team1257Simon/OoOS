...
long double _strtold_r(struct _reent* ptr, const char* restrict s00, char** restrict se)
{
    long double result;
    _strtorx_l(ptr, s00, se, __flt_rounds(), &result, __get_current_locale());
    return result;
}
long double strtold_l(const char* restrict s00, char** restrict se, locale_t loc)
{
    long double result;
    _strtorx_l(_impure_ptr, s00, se, __flt_rounds(), &result, loc);
    return result;
}
long double strtold(const char* restrict s00, char** restrict se)
{
    long double result;
    _strtorx_l(_impure_ptr, s00, se, __flt_rounds(), &result, __get_current_locale());
    return result;
}
