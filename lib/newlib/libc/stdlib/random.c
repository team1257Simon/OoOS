...
long int random(void)
{
    struct _reent* reent = _impure_ptr;
    ;
    ((reent)->_new._reent._rand_next) = ((reent)->_new._reent._rand_next) * __extension__ 6364136223846793005LL + 1;
    return (long int)((((reent)->_new._reent._rand_next) >> 32) & 0x7fffffff);
}
