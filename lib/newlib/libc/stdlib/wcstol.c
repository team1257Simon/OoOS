...
static long                                   _wcstol_l(struct _reent* rptr, const wchar_t* nptr, wchar_t** endptr, int base, locale_t loc)
{
...
long wcstol_l(const wchar_t* restrict s, wchar_t** restrict ptr, int base, locale_t loc) { return _wcstol_l(_impure_ptr, s, ptr, base, loc); }
long wcstol(const wchar_t* restrict s, wchar_t** restrict ptr, int base) { return _wcstol_l(_impure_ptr, s, ptr, base, __get_current_locale()); }
