...

{
  ...
  {
    case -1:
      __malloc_trim_threshold = value; __malloc_unlock(reent_ptr); return 1;
    case -2:
      __malloc_top_pad = value; __malloc_unlock(reent_ptr); return 1;
    case -3:
    ...
    case -4:
      ...
      __malloc_unlock(reent_ptr); return value == 0;
