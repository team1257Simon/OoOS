...
static intmax_t _wcstoimax_l(struct _reent* rptr, const wchar_t* restrict nptr, wchar_t** restrict endptr, int base, locale_t loc)
{
    ...
    noconv:
        ...
        acc = -acc;
    if(endptr != ((void*)0)) *endptr = (wchar_t*)(any ? s - 1 : nptr);
    return (acc);
}
intmax_t _wcstoimax_r(struct _reent* rptr, const wchar_t* restrict nptr, wchar_t** restrict endptr, int base)
{
    return _wcstoimax_l(rptr, nptr, endptr, base, __get_current_locale());
}
intmax_t wcstoimax_l(const wchar_t* restrict nptr, wchar_t** restrict endptr, int base, locale_t loc)
{
    return _wcstoimax_l(_impure_ptr, nptr, endptr, base, loc);
}
intmax_t wcstoimax(const wchar_t* restrict nptr, wchar_t** restrict endptr, int base)
{
    return _wcstoimax_l(_impure_ptr, nptr, endptr, base, __get_current_locale());
}
