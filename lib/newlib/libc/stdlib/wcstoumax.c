...
static uintmax_t _wcstoumax_l(struct _reent* rptr, const wchar_t* restrict nptr, wchar_t** restrict endptr, int base, locale_t loc)
{
...
uintmax_t _wcstoumax_r(struct _reent* rptr, const wchar_t* restrict nptr, wchar_t** restrict endptr, int base)
{
    return _wcstoumax_l(rptr, nptr, endptr, base, __get_current_locale());
}
uintmax_t wcstoumax_l(const wchar_t* restrict nptr, wchar_t** restrict endptr, int base, locale_t loc)
{
    return _wcstoumax_l(_impure_ptr, nptr, endptr, base, loc);
}
uintmax_t wcstoumax(const wchar_t* restrict nptr, wchar_t** restrict endptr, int base)
{
    return _wcstoumax_l(_impure_ptr, nptr, endptr, base, __get_current_locale());
}
