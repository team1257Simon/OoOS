      ...
      for (optindex = 0; longopts[optindex].name != 0; ++optindex)
 {
       ...
       else
  {
        ...
        if (data->opterr)
   {
     ...
     fputs (argv[data->optind], 
                               (_impure_ptr->_stderr)
                                     );
     fputs ("' is ambiguous (could be `--", 
                                           (_impure_ptr->_stderr)
                                                 );
     fputs (longopts[longopt_match].name, 
                                         (_impure_ptr->_stderr)
                                               );
     fputs ("' or `--", 
                       (_impure_ptr->_stderr)
                             );
     fputs (longopts[optindex].name, 
                                    (_impure_ptr->_stderr)
                                          );
     fputs ("')\n", 
                   (_impure_ptr->_stderr)
   ...
   if (data->opterr)
     {
       ...
       fputc (argv[data->optind][data->optwhere], 
                                                 (_impure_ptr->_stderr)
                                                       );
       fputs ("'\n", 
                    (_impure_ptr->_stderr)
   ...
   if (data->opterr)
     {
       ...
       fputs (": argument required for option `-", 
                                                  (_impure_ptr->_stderr)
                                                        );
       if (longopt_match >= 0)
  {
