...
static uintmax_t _strtoumax_l(struct _reent* rptr, const char* restrict nptr, char** restrict endptr, int base, locale_t loc)
{
    const char* s = nptr;
    uintmax_t   acc;
    char        c;
    ...
    cutoff = (0xffffffffffffffffUL) / base;
    cutlim = (0xffffffffffffffffUL) % base;
    for(;; c = *s++)
    {
        if(c >= '0' && c <= '9')
            c -= '0';
...
uintmax_t _strtoumax_r(struct _reent* rptr, const char* restrict nptr, char** restrict endptr, int base)
{
    return _strtoumax_l(rptr, nptr, endptr, base, __get_current_locale());
}
uintmax_t strtoumax_l(const char* restrict nptr, char** restrict endptr, int base, locale_t loc)
{
    return _strtoumax_l(_impure_ptr, nptr, endptr, base, loc);
}
uintmax_t strtoumax(const char* restrict nptr, char** restrict endptr, int base)
{
    return _strtoumax_l(_impure_ptr, nptr, endptr, base, __get_current_locale());
}
