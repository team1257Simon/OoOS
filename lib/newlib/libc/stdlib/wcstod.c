                                                            ...
                                                            endptr)
{
  return _wcstod_l (
                   _impure_ptr
                         , nptr, endptr, __get_current_locale ());
}

float
wcstof_l (const wchar_t *
                        restrict 
                                   nptr, wchar_t **
                                                   restrict 
                                                              endptr,
