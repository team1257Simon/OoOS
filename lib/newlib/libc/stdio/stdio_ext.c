...
size_t __fbufsize(FILE* fp) { return (size_t)fp->_bf._size; }
size_t __fpending(FILE* fp) { return fp->_p - fp->_bf._base; }
int    __flbf(FILE* fp) { return (fp->_flags & 0x0001) != 0; }
int    __freadable(FILE* fp) { return (fp->_flags & (0x0004 | 0x0010)) != 0; }
int    __fwritable(FILE* fp) { return (fp->_flags & (0x0008 | 0x0010)) != 0; }
int    __freading(FILE* fp) { return (fp->_flags & 0x0004) != 0; }
int    __fwriting(FILE* fp) { return (fp->_flags & 0x0008) != 0; }
