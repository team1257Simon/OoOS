...
typedef int (*funread)(void *_cookie, char *_buf, 
                                                 int 
                                                                          _n);
       ...
       int whence)
{
 ...
 (*__errno()) 
       = 0;
  if ((result = c->seekfn (c->cookie, (fpos_t) off, whence)) < 0 && 
                                                                   (*__errno())
                                                                        )
    ptr->_errno = 
                 (*__errno())
       ...
       funclose closefn)
{
  ...
  if ((fp = __sfp (ptr)) == 
    ...
    return 
          ((void *)0)
              ;
  if ((c = (funcookie *) _malloc_r (ptr, sizeof *c)) == 
                                                       ((void *)0)
                                                           )
    {
      { __sfp_lock_acquire ();
