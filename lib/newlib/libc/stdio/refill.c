...
{
    if((fp->_flags & (0x0001 | 0x0008)) == (0x0001 | 0x0008)) return fflush(fp);
    return 0;
}
int __srefill_r(struct _reent* ptr, register FILE* fp)
{
    ...
    if(fp->_flags & (0x0001 | 0x0002))
    {
        ...
        if((fp->_flags & (0x0001 | 0x0008)) == (0x0001 | 0x0008)) __sflush_r(ptr, fp);
    }
    fp->_p = fp->_bf._base;
