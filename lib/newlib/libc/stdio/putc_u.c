...
int _putc_unlocked_r(struct _reent* ptr, int c, register FILE* fp) { return __sputc_r(ptr, c, fp); }
int putc_unlocked(int c, register FILE* fp) { return __sputc_r(_impure_ptr, c, fp); }
