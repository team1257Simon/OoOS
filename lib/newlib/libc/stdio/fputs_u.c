...
int                     _fputs_unlocked_r(struct _reent* ptr, char const* restrict s, FILE* restrict fp)
{
    int           result;
    struct __suio uio;
    struct __siov iov;
...
int fputs_unlocked(char const* restrict s, FILE* restrict fp) { return _fputs_unlocked_r(_impure_ptr, s, fp); }
