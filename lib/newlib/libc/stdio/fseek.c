...
int                     _fseek_r(struct _reent* ptr, register FILE* fp, long offset, int whence) { return _fseeko_r(ptr, fp, offset, whence); }
int                     fseek(register FILE* fp, long offset, int whence) { return _fseek_r(_impure_ptr, fp, offset, whence); }
