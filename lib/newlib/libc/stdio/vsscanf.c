...
int                     vsscanf(const char* restrict str, const char* restrict fmt, va_list ap) { return _vsscanf_r(_impure_ptr, str, fmt, ap); }
int                     _vsscanf_r(struct _reent* ptr, const char* restrict str, const char* restrict fmt, va_list ap)
{
    FILE f;
