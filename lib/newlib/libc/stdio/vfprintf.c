...
reswitch: switch (ch) {
  ...
  case 'i':
   _uquad = (flags&0x010 ? (
           ...
           ) : flags&0x040 ? (long)(short)(
           __builtin_va_arg(
           ap
           ,
           int
           )
           ) : flags&0 ? (long)(signed char)(
           __builtin_va_arg(
           ap
           ,
           int
  ...
  case 'o':
   _uquad = (flags&0x010 ? (
           ...
           ) : flags&0x040 ? (u_long)(u_short)(
           __builtin_va_arg(
           ap
           ,
           int
           )
           ) : flags&0 ? (u_long)(unsigned char)(
           __builtin_va_arg(
           ap
           ,
           int
