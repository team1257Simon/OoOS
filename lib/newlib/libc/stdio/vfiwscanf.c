...
int                     vfiwscanf(register FILE* restrict fp, const wchar_t* restrict fmt, va_list ap)
{
...
int __svfiwscanf(register FILE* fp, wchar_t const* fmt0, va_list ap) { return __svfiwscanf_r(_impure_ptr, fp, fmt0, ap); }
int _vfiwscanf_r(struct _reent* data, register FILE* fp, const wchar_t* fmt, va_list ap)
{
    do {
...
int __svfiwscanf_r(struct _reent* rptr, register FILE* fp, wchar_t const* fmt0, va_list ap)
{
