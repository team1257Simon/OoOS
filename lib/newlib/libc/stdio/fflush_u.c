...
int                     _fflush_unlocked_r(struct _reent* ptr, register FILE* fp)
{
    int ret;
    do {
...
int fflush_unlocked(register FILE* fp)
{
    if(fp == ((void*)0)) return _fwalk_reent(_global_impure_ptr, _fflush_unlocked_r);
    return _fflush_unlocked_r(_impure_ptr, fp);
}
