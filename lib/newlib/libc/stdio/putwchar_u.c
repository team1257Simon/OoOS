...
wint_t                  _putwchar_unlocked_r(struct _reent* ptr, wchar_t wc) { return _fputwc_unlocked_r(ptr, wc, (_impure_ptr->_stdout)); }
wint_t                  putwchar_unlocked(wchar_t wc)
{
    ;
    return fputwc_unlocked(wc, (_impure_ptr->_stdout));
}
