 ...
 case 0:
  ...
  p = (
     ...
     wchar_t *
       ...
       n = 0;
       while (width-- != 0 && (wi = _fgetwc_r (rptr, fp)) != 
                                                            ((wint_t)-1)
                                                                )
  {
    if (!(flags & 0x10))
   ...
   if ((flags & 0x10) && (flags & 0x01))
     {
      ...
      && width-- != 0 && (cclcompl ? (wmemchr(ccls, (wi), ccle - ccls) == 
                         ((void *)0)
                         ) : (wmemchr(ccls, (wi), ccle - ccls) != 
                         ((void *)0)
                         )))
  n++;
       if (wi != 
 ...
 case 4:
 {
       ...
       if ((flags & (0x200 | 0x400)) == 0x400)
  {
    ...
    exp_start = p;
                ...
                new_exp = _wcstol_r (rptr, (exp_start + 1), 
                                                           ((void *)0)
                                                               , 10) - exp_adjust;
       if (exp_adjust)
  {
    ...
    if (exp_start >= buf + sizeof (buf) / sizeof (*buf)
       - ((8 
        * sizeof (long) - 1) * 4 / 13 + 2))
      exp_start = buf + sizeof (buf) / sizeof (*buf)
    - ((8 
     * sizeof (long) - 1) * 4 / 13 + 2) - 1;
                 swprintf (exp_start, ((8 
                                     * sizeof (long) - 1) * 4 / 13 + 2), L"e%ld", new_exp);
  }
