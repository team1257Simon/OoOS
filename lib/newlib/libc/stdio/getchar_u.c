...
int _getchar_unlocked_r(struct _reent* ptr) { return _getc_unlocked_r(ptr, ((ptr)->_stdin)); }
int getchar_unlocked(void) { return _getc_unlocked_r(_impure_ptr, ((_impure_ptr)->_stdin)); }
