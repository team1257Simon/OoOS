...
size_t                  _fread_unlocked_r(struct _reent* ptr, void* restrict buf, size_t size, size_t count, FILE* restrict fp)
{
...
size_t fread_unlocked(void* restrict buf, size_t size, size_t count, FILE* restrict fp)
{
    return _fread_unlocked_r(_impure_ptr, buf, size, count, fp);
}
