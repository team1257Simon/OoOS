...
int _getc_unlocked_r(struct _reent* ptr, register FILE* fp) { return (--(fp)->_r < 0 ? __srget_r(ptr, fp) : (int)(*(fp)->_p++)); }
int getc_unlocked(register FILE* fp) { return (--(fp)->_r < 0 ? __srget_r(_impure_ptr, fp) : (int)(*(fp)->_p++)); }
