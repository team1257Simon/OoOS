...
int                     vsprintf(char* restrict str, const char* restrict fmt, va_list ap) { return _vsprintf_r(_impure_ptr, str, fmt, ap); }
int                     _vsprintf_r(struct _reent* ptr, char* restrict str, const char* restrict fmt, va_list ap)
{
    int  ret;
    FILE f;
