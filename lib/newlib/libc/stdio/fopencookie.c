                               ...
                               n)
{
 ...
 (*__errno()) 
       = 0;
  if ((result = c->readfn (c->cookie, buf, n)) < 0 && 
                                                     (*__errno())
                                                          )
    ptr->_errno = 
                 (*__errno())
                               ...
                               n)
{
 ...
 (*__errno()) 
       = 0;
  if ((result = c->writefn (c->cookie, buf, n)) < 0 && 
                                                      (*__errno())
                                                           )
    ptr->_errno = 
                 (*__errno())
       ...
       int whence)
{
 ...
 (*__errno()) 
       = 0;
  if (c->seekfn (c->cookie, &offset, whence) < 0 && 
                                                   (*__errno())
                                                        )
    ptr->_errno = 
                 (*__errno())
  ...
  if (c->closefn)
    {
     ...
     (*__errno()) 
           = 0;
      if ((result = c->closefn (c->cookie)) < 0 && 
                                                  (*__errno())
                                                       )
 ptr->_errno = 
              (*__errno())
       ...
       cookie_io_functions_t functions)
{
  ...
  if ((fp = __sfp (ptr)) == 
    ...
    return 
          ((void *)0)
              ;
  if ((c = (fccookie *) _malloc_r (ptr, sizeof *c)) == 
                                                      ((void *)0)
                                                          )
    {
      { __sfp_lock_acquire ();
 ...
 fp
  ...
  fp->_seek = functions.seek ? fcseeker : 
                                         ((void *)0)
                                             ;
...
fopencookie (void *cookie,
       ...
       cookie_io_functions_t functions)
{
  return _fopencookie_r (
                        _impure_ptr
                              , cookie, mode, functions);
}
