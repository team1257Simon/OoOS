...
wint_t                  _putwc_unlocked_r(struct _reent* ptr, wchar_t wc, FILE* fp) { return _fputwc_unlocked_r(ptr, wc, fp); }
wint_t                  putwc_unlocked(wchar_t wc, FILE* fp) { return fputwc_unlocked(wc, fp); }
