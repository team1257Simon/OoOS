...
int                     _vdprintf_r(struct _reent* ptr, int fd, const char* restrict format, va_list ap)
{
    char*  p;
    char   buf[512];
    size_t n = sizeof buf;
...
int vdprintf(int fd, const char* restrict format, va_list ap) { return _vdprintf_r(_impure_ptr, fd, format, ap); }
