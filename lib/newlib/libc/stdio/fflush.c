       ...
       register FILE * fp)
{
                                                         ...
                                                         )
 {
  ...
  curoff = fp->_seek (ptr, fp->_cookie, 0, 
                                          1
                                                  );
       if (curoff == -1L && ptr->_errno != 0)
  {
    ...
    return result;
     ...
     curoff = fp->_seek (ptr, fp->_cookie, curoff, 
                                                  0
                                                          );
   if (curoff != -1 || ptr->_errno == 0
                                                       ...
                                                       )
     {
       ...
       if ((fp->_flags & 
                        0x1000
                              ) && (curoff != -1 || ptr->_errno == 0))
  fp->_offset = curoff;
       ptr->_errno = tmp_errno;
       if (((fp)->_ub._base != 
          ((void *)0)
          ))
  { if ((fp)->_ub._base != (fp)->_ubuf) _free_r(ptr, (char *)(fp)->_ub._base); (fp)->_ub._base = 
 ((void *)0)
 ; };
     }
   else
