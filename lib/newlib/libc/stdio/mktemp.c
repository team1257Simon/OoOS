       ...
       int flags)
{
  ...
  return (_gettemp (ptr, path, &fd, 0, 0, flags & ~
                                                  (0|1|2)
                                                           ) ? fd : -1);
}
       ...
       int flags)
{
  ...
  return (_gettemp (ptr, path, &fd, 0, len, flags & ~
                                                    (0|1|2)
                                                             ) ? fd : -1);
}
