...
static const float two25 = 3.3554432000e+07, ivln10 = 4.3429449201e-01, log10_2hi = 3.0102920532e-01, log10_2lo = 7.9034151668e-07;
...
float              __ieee754_log10f(float x)
{
    ...
    k = 0;
    if(((hx & 0x7fffffff) == 0)) return -two25 / zero;
