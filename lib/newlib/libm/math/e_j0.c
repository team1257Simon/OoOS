...
static const double huge = 1e300, one = 1.0, invsqrtpi = 5.64189583547756279280e-01, tpi = 6.36619772367581382433e-01,
                    R02 = 1.56249999999999947958e-02, R03 = -1.89979294238854721751e-04, R04 = 1.82954049532700665670e-06,
                    R05 = -4.61832688532103189199e-09, S01 = 1.56191029464890010492e-02, S02 = 1.16926784663337450260e-04,
...
double              __ieee754_j0(double x)
{
    ...
    if(ix < 0x3FF00000) { return one + z * (-0.25 + (r / s)); }
    else
    {
        u = 0.5 * x;
...
static const double u00 = -7.38042951086872317523e-02, u01 = 1.76666452509181115538e-01, u02 = -1.38185671945596898896e-02,
                    u03 = 3.47453432093683650238e-04, u04 = -3.81407053724364161125e-06, u05 = 1.95590137035022920206e-08,
                    u06 = -3.98205194132103398453e-11, v01 = 1.27304834834123699328e-02, v02 = 7.60068627350353253702e-05,
...
double __ieee754_y0(double x)
{
    ...
    if(ix <= 0x3e400000) { return (u00 + tpi * __ieee754_log(x)); }
    z = x * x;
