...
static const double one = 1.00000000000000000000e+00, ln2 = 6.93147180559945286227e-01, huge = 1.00000000000000000000e+300;
double              asinh(double x)
{
    ...
    if(ix > 0x41b00000) { w = __ieee754_log(fabs(x)) + ln2; }
