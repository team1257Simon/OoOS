...
static const float one = 1.0,
                   ...
                   huge = 1.0e+30, twom100 = 7.8886090522e-31,
                   ln2HI[2] =
                       {
                           6.9313812256e-01,
                           -6.9313812256e-01,
                   ...
                   invln2 = 1.4426950216e+00, P1 = 1.6666667163e-01, P2 = -2.7777778450e-03, P3 = 6.6137559770e-05, P4 = -1.6533901999e-06,
                   P5 = 4.1381369442e-08;
float __ieee754_expf(float x)
{
    ...
    if(((hx) == 0x7f800000L)) return (xsb == 0) ? x : 0.0;
    if(sx > 0x42b17217) return huge * huge;
    if(sx < 0 && hx > 0x42cff1b5) return twom100 * twom100;
    if(hx > 0x3eb17218)
    {
        if(hx < 0x3F851592)
        {
