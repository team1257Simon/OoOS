...
static const float one = 1.0000000000e+00, C1 = 4.1666667908e-02, C2 = -1.3888889225e-03, C3 = 2.4801587642e-05, C4 = -2.7557314297e-07,
                   C5 = 2.0875723372e-09, C6 = -1.1359647598e-11;
float __kernel_cosf(float x, float y)
{
    ...
    {
        if(ix > 0x3f480000) { qx = (float)0.28125; }
        else
        {
            do {
