...
static const float one = 1.0, huge = 1.0e+30, tiny = 1.0e-30, ln2_hi = 6.9313812256e-01, ln2_lo = 9.0580006145e-06, invln2 = 1.4426950216e+00,
                   Q1 = -3.3333335072e-02, Q2 = 1.5873016091e-03, Q3 = -7.9365076090e-05, Q4 = 4.0082177293e-06, Q5 = -2.0109921195e-07;
float expm1f(float x)
{
    ...
    if(hx >= 0x4195b844)
    {
        ...
        if(((hx) == 0x7f800000L)) return (xsb == 0) ? x : -1.0;
        if(xsb == 0 && hx > 0x42b17217) return huge * huge;
        if(xsb != 0)
        {
            if(x + tiny < (float)0.0) return tiny - one;
        }
    }
    if(hx > 0x3eb17218)
    {
    ...
    else
    {
        ...
        if(k < 23)
        {
            ...
            do {
                ieee_float_shape_type sf_u;
                sf_u.word = (0x3f800000 - (0x1000000 >> k));
                (t)       = sf_u.value;
            } while(0);
            y = t - (e - x);
            do {
