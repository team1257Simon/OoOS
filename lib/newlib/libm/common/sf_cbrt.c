...
static const __uint32_t B1 = 709958130, B2 = 642849266;
static const float      C = 5.4285717010e-01, D = -7.0530611277e-01, E = 1.4142856598e+00, F = 1.6071428061e+00, G = 3.5714286566e-01;
float                   cbrtf(float x)
{
    __int32_t  hx;
    float      r, s, t;
