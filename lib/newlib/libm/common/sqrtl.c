...
long double sqrtl(long double x)
{
    ...
    int         k;
    long double lo, xn;
    if(ux.extu_ext.ext_exp == 16384 * 2 - 1) return (x * x + x);
    ...
    if(ux.extu_ext.ext_exp == 0)
    {
        ...
        k = 0;
    if((ux.extu_ext.ext_exp - ((1 << (15 - 1)) - 1)) & 1)
    {
        k += ux.extu_ext.ext_exp - ((1 << (15 - 1)) - 1) - 1;
        ux.extu_ext.ext_exp = ((1 << (15 - 1)) - 1) + 1;
    }
    else
    {
        k += ux.extu_ext.ext_exp - ((1 << (15 - 1)) - 1);
        ux.extu_ext.ext_exp = ((1 << (15 - 1)) - 1);
    }
    xn                    = sqrt((double)ux.extu_ld);
    lo                    = ux.extu_ld;
    ux.extu_ext.ext_fracl = 0;
    lo                    = (lo - ux.extu_ld) / xn;
    xn                    = xn + (ux.extu_ld / xn);
    ux.extu_ld            = xn + lo;
