...
long long int llrint(double x)
{
    ...
    {
        if(j0 >= 52)
            result = ((long long int)((i0 & 0x000fffff) | 0x00100000) << (j0 - 20)) | ((long long int)i1 << (j0 - 52));
        else
        {
            w = TWO52[sx] + x;
            t = w - TWO52[sx];
            ...
            i0 &= 0x000fffff;
            i0 |= 0x00100000;
            result = ((long long int)i0 << (j0 - 20)) | ((((52 - j0)) < 8 * sizeof(i1)) ? ((i1) >> ((52 - j0))) : 0);
        }
    }
    else { return (long long int)x; }
