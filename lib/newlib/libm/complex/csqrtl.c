...
_Bool 
 ...
 if (
  ...
  if (
   ...
   return (((__builtin_fabsl(b - b)) + (__builtin_copysignl(a, b)) * 
          1.0fi
          ));
  else
   return (((a) + (__builtin_copysignl(b - b, b)) * 
          1.0fi
          ));
 }
 ...
 if (__builtin_fabsl(a) >= (1.18973149535723176502126385303097021e+4932L 
                          / 2.414213562373095048801688724209698L) || __builtin_fabsl(b) >= (1.18973149535723176502126385303097021e+4932L 
                                                          / 2.414213562373095048801688724209698L)) {
  a *= 0.25L;
  b *= 0.25L;
  scale = 
         1
 ...
 if (a >= 0L) {
  ...
  t = sqrtl((-a + hypotl(a, b)) * 0.5L);
  result = ((__builtin_fabsl(b) / (2.0L * t)) + (__builtin_copysignl(t, b)) * 
          1.0fi
          );
 }
